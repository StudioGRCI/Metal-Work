      ...
      {abierto && (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/50 p-4 py-10">
          <div
            role="dialog"
            aria-modal="true"
            aria-label="Registrar el avance del día"
          ...
          >
            <h2 className="text-base font-semibold text-texto">Avance del día</h2>
            <p className="mt-1 text-xs text-texto-suave">
              Qué se hizo hoy en esta unidad. Con la foto, el cliente y la gerencia ven cómo va sin
              tener que bajar al taller.
            </p>
            ...
            >
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                >
                  <Entrada id="impedimento" name="impedimento" placeholder="Nada" />
                </Campo>
              </div>
